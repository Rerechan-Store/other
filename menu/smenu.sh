...
echo -e "\e[$line═════════════════════════════════\e[m"
echo -e " Link Yaml     : http://$domain:8000/$ssr_user-clash-for-android.yaml"
echo -e "\e[$line═════════════════════════════════\e[m"
...
cp /etc/shadowsocks-libev/$user-yaml-tls.yaml /var/www/html/$user-yaml-tls.yaml
cp /etc/shadowsocks-libev/$user-yaml-http.yaml /var/www/html/$user-yaml-http.yaml
...
clear
	...
	echo -e "\e[$line═════════════════════════════════\e[m"
	echo -e "Link YAML TLS  : http://$domain:8000/$user-yaml-tls.yaml"
	echo -e "\e[$line═════════════════════════════════\e[m"
	echo -e "Link YAML HTTP : http://$domain:8000/$user-yaml-http.yaml"
	echo -e "\e[$line═════════════════════════════════\e[m"
}
...
echo -e "
=================================
[ <= Shadowsodkcs-Libev Menu => ]
=================================
      [ Shadowsocsk R ]
         
1. Create Akaun ShadowsocksR
2. Delete Akaun ShadowsocksR
3. Extend EXP Akaum ShadowsocksR
4. Show Other Menu Shadowsocks Menu
=================================
       [ Shadowsocks ]

5. Create Akaun Shadowsocks
6. Delete Akaun Shadowsocks
7. Extend Akaun Shadowsocks
8. Cek User Login Shadowsocks
=================================

x) Back To Menu
=================================
"
read -p "Please Input Number  [1-8 or x] :  "  anbu
case $anbu in
1) xp ; clear ; addssr ;;
 2) xp ; clear ; delssr ;;
  3) xp ; clear ; renssr ;;
